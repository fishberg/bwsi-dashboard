...
| How do I register for additional courses? | Your login for [BWSIX](https://bwsix.mit.edu/dashboard) provides access to any of the 2020 courses, and you self-register by selecting the course and starting it (dont forget each course has its own piazza forum).|
